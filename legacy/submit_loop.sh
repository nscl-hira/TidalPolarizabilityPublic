...
do
    ...
    mpiexec -np ${NODES} --bind-to none --mca btl tcp,self --oversubscribe python -W ignore GenerateReport.py -i \${INPUT} -o ${OUTPUT}_\${ID} -c ${CORES} -pd 0.3 -pp 2.5 -et Meta2Poly --PBar -tg 1 1.1 1.2 1.3 1.4 1.5 1.7 1.7 1.8 1.9 2
